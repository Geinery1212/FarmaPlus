...
class pedidoController
{
	...
	public function pagoCompletado()
	{
		if (isset($_GET['paymentID']) && isset($_GET['pedido_id'])) {
			...
			$paypalClientID = 'AfqYGWG766pnnSs5SEr9zAUDXcHnlkO6QExSePpHhK-ns8yQZAJCBJqIXJWf_yjhb4Y9OcxDY8C0qqFk';
			$paypalSecret = 'EBcaJWvzIciaOrQlHuINquBH-zNSRYfDgmD1E0eYXHUPSweazdmFzfo_0e2-y57hbuuPkhi79TrzutGT';
			...
			if ($token) {
				...
				if ($paymentValid) {
					...
					try {
						...
						$mail->setFrom('farmaplus656@gmail.com', 'FarmaPlus');
