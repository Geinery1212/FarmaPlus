...
<body data-bgcolor="Body" style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-bottom: 0; width: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;" bgcolor="#F4F4F4">
    ...
    <div data-primary-font="Poppins" data-secondary-font="Roboto" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">
    </div>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="width:100%;max-width:100%;">
        <tr><!-- Outer Table -->
            <td align="center" data-bgcolor="Body" bgcolor="#F4F4F4" data-composer>
                ...
                <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="colibri-preheader-16">
                    <!-- colibri-preheader-16 -->
                    <tr>
                        <td align="center" bgcolor="#fafafa" data-bgcolor="BgColor">
                            ...
                            <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row" width="580" style="width:580px;max-width:580px;">
                                            ...
                                            <tr>
                                                <td class="rwd-col" align="center" width="46.66%" style="width:46.66%;max-width:46.66%;">
                                                    ...
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                                        <tr data-element="colibri-preheader-16-title" data-label="Titles">
                                                            <td class="center-text" align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:9px;line-height:12px;font-style:normal;font-weight:700;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                                FarmaPlus
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="rwd-col" align="center" width="46.66%" style="width:46.66%;max-width:46.66%;">
                                                    ...
                                                    <!-- column -->
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                                        <tr data-element="colibri-preheader-16-webview" data-label="Webview">
                                                            <td class="center-text" align="right">
                                                                <webversion href="#" data-mergetag="Web version" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:9px;line-height:12px;font-style:normal;font-weight:700;color:#333333;text-decoration:underline;letter-spacing:0px;">
                                                                    Consulta desde tu navegador</webversion>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- column -->
                                ...
                                <tr data-element="colibri-preheader-16-logo" data-label="Logo">
                                    <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing above logo">&nbsp;</td>
                                </tr>
                                <tr data-element="colibri-preheader-16-logo" data-label="Logo">
                                    <td align="center" class="center-text">
                                        <img style="width:220px;border:0px;display: inline!important;" src="https://i.postimg.cc/BbYqNXGC/logo-farmacia.png" width="220" border="0" editable="true" data-icon data-image-edit data-url data-label="Logo" data-image-width alt="logo">
                                    </td>
                                </tr>
                                <tr>
                ...
                <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="colibri-basic-message-16">
                    <!-- colibri-basic-message-16 -->
                    <tr>
                        <td align="center" bgcolor="#fafafa" data-bgcolor="BgColor">
                            ...
                            <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row container-padding" width="580" style="width:580px;max-width:580px;">
                                <tr>
                                    <td height="15" style="font-size:15px;line-height:15px;" data-height="Spacing top">
                                        &nbsp;</td>
                                </tr>
                                ...
                                <tr data-element="colibri-bm-paragraph" data-label="Paragraphs">
                                    <td class="center-text" data-text-style="Paragraphs" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                        <singleline>
                                            <div mc:edit data-text-edit>
                                                Hola <?= $nombre_usuario ?>, estamos preparando tu pedido. Te
                                                notificaremos cuando haya sido enviado.
                                            </div>
                                        </singleline>
                                    </td>
                                </tr>
                                                        ...
                                                        <tr>
                                                            <td class="rwd-col" align="center" valign="top" width="48.96%" style="width:48.96%;max-width:48.96%;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                                                    ...
                                                                    <tr data-element="colibri-content-titles" data-label="Titles">
                                                                        <td height="10" style="font-size:10px;line-height:10px" data-height="Spacing under titles">&nbsp;
                                                                        </td>
                                                                    </tr>
                                                                    <tr data-element="colibri-content-paragraph" data-label="Paragraphs">
                                                                        <td class="center-text" data-text-style="Paragraphs" align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:20px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;padding-bottom: 15px;">
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    <?= $pedido->id ?>
                                                                                </div>
                                                            ...
                                                            <td class="rwd-col" align="center" width="2.08%" height="30" style="width:2.08%;max-width:2.08%;height: 30px;">&nbsp;
                                                            </td>
                                                            <td class="rwd-col" align="center" valign="top" width="48.96%" style="width:48.96%;max-width:48.96%;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                                                    <tr data-element="colibri-content-titles" data-label="Titles">
                                                                        <td class="center-text" data-text-style="Titles" align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;padding-bottom: 25px;">
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit style="color: #127c5f  !important;">
                                                                                    <a style="color: #127c5f  !important;" href="http://localhost:4200/cuenta/pedidos/<%= orden._id; %>">
                                                                                        Ver mi pedido
                                                                                    </a>
                                                                                </div>
                                                                            </singleline>
                                                                    ...
                                                                    <tr data-element="colibri-content-titles" data-label="Titles">
                                                                        <td class="center-text" data-text-style="Titles" align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit style="color: #127c5f !important;">
                                                                                    <a style="color: #127c5f  !important;" href="http://localhost:4200/">
                    ...
                    <tr>
                        <td align="center" bgcolor="#fafafa" data-bgcolor="BgColor" height="50" style="font-size:50px;line-height:50px;">
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="container-padding" width="100%" style="width:100%;max-width:100%;">
                                <tr>
                                    <td align="center" height="3" data-bgcolor="Dividers" style="font-size:3px;line-height:3px;border-top: 3px dotted #AAAAAA;">&nbsp;
                                    </td>
                                </tr>
                            </table>
                        </td>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" width="4%" style="width:4%;max-width:4%;">
                                                            </td>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" align="center" class="container-padding" width="100%" style="width:100%;max-width:100%;">
                                                        <tr>
                                                            ...
                                                            <td class="rwd-col" align="center" width="5.17%" height="30" style="width:5.17%;max-width:5.17%;height: 30px;">&nbsp;
                                                            </td>
                                                            <td class="rwd-col" align="center" valign="top" width="43.1%" style="width:43.1%;max-width:43.1%;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <!-- row -->
                                                                            <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="center-float" style="    float: left !important;">
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        ...
                                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" width="70" style="width:70px;max-width:70px;">
                                                                                            <tr data-element="Colibri-content-titles" data-label="Subtotal number">
                                                                                                <td data-text-style="Calculation" align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:18px;line-height:30px;font-weight:400;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
                                                                                                    <singleline>
                                                                                                        <div mc:edit data-text-edit>
                                                                                                            <?= $pedido->coste ?><small style="font-size: 12px !important;">MXN</small>
                                                                                                        </div>
                                                                                                    </singleline>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr data-element="Colibri-content-titles" data-label="Shipping number">
                                                                                                <td data-text-style="Calculation" align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:18px;line-height:30px;font-weight:400;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
                                                                                                    <singleline>
                                                                                                        <div mc:edit data-text-edit>
                                                                                                            0.0<small style="font-size: 12px !important;">MXN</small>
                                                                                                        </div>
                                                                                                    </singleline>
                                                                                                </td>
                                                                                            </tr>
                                                        ...
                                                        <tr>
                                                            <td class="rwd-col" align="center" valign="top" width="41.38%" style="width:41.38%;max-width:41.38%;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                                                    ...
                                                                    <tr data-element="colibri-content-titles" data-label="Titles">
                                                                        <td class="center-text" data-text-style="Titles" align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:18px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;padding-bottom: 20px;">
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit style="color: #127c5f ;">
                                                                                    ¿Sabes cómo mantenerte al tanto de
                                                                                    todos los detalles de tus pedidos,
                                                                                    direcciones y reseñas en cualquier
                                                                                    momento?
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                                                    ...
                                                                    <tr data-element="colibri-content-paragraph" data-label="Paragraphs">
                                                                        <td class="center-text" data-text-style="Paragraphs" align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:30px;font-weight:400;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;padding-bottom: 20px;">
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit style="color: #127c5f ;">
                                                                                    Ingresa a <a href="http://localhost:4200/" target="_blank">www.domain.com</a>,
                                                                                    Iniciar sesión, dale click a "Mi
                                                                                    cuenta" y listo.
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="480" style="width:480px;max-width:480px;">
                                                        <tr>
                                                            <td class="center-text" data-text-style="Paragraphs" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:26px;font-weight:400;font-style:italic;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                                <singleline>
                                                                    <div mc:edit data-text-edit>
                                                                        Si tienes alguna pregunta solo responde a este
                                                                        correo electrónico o contactanos a traves de
                                                                        <span style="color: #127c5f ;">contacto@domain.com</span>
                                                                    </div>
                                                                </singleline>
                                                            </td>
                                                        </tr>
